...
//        Archivo archivo2 = new Archivo("archivo2.txt", 2, 1, 3, 1, "Contenido de archivo2", "azul");
//        Archivo archivo3 = new Archivo("archivo3.txt", 3, 2, 4, 2, "Contenido de archivo3", "azulOscuro");
//        Archivo archivo4 = new Archivo("archivo4.txt", 4, 1, 0, 2, "Contenido de archivo4", "naranja");
//        Archivo archivo5 = new Archivo("archivo5.txt", 5, 1, 0, 4, "Contenido de archivo5", "naranjaoscuro");
//        Archivo archivo6 = new Archivo("archivo1.txt", 1, 2, 0, 1, "Contenido duplicado de archivo1", "rojo"); // Duplicado
//        Archivo archivo7 = new Archivo("archivo3.txt", 3, 2, 4, 3, "Contenido duplicado de archivo3", "azuloscuro"); // Duplicado
//        Archivo archivo8 = new Archivo("archivo6.txt", 6, 1, 0, 5, "Contenido de archivo6", "rosa");
//        Archivo archivo9 = new Archivo("archivo7.txt", 7, 1, 1, 6, "Contenido de archivo7", "verde");
//        Archivo archivo10 = new Archivo("archivo8.txt", 8, 1, 0, 7, "Contenido de archivo8", "rosaoscuro");
